...
export default function CartScreen() {
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40, paddingBottom: 100 }}>
          {isDesktop ? (
            <View style={{ alignItems: 'center' }}>
              <View style={{ 
                width: 140, height: 140, borderRadius: 70, backgroundColor: '#F3F4F6',
                justifyContent: 'center', alignItems: 'center', marginBottom: 32
              }}>
                <ShoppingBag size={60} color="#9CA3AF" strokeWidth={1.5} />
              </View>
              <Text style={{ fontSize: 24, fontWeight: '900', color: '#111827', marginBottom: 16 }}>Tu carrito está vacío</Text>
              <Text style={{ fontSize: 16, color: '#6B7280', textAlign: 'center', marginBottom: 40, maxWidth: 400 }}>
                Parece que aún no has agregado nada. ¡Explora nuestra tienda y encuentra lo mejor para tu mascota!
              </Text>
              <TouchableOpacity 
                onPress={() => router.push('/')}
                style={{ backgroundColor: '#F47321', borderRadius: 16, paddingVertical: 18, paddingHorizontal: 40 }}
              >
                <Text style={{ color: 'white', fontSize: 16, fontWeight: '900' }}>Explorar tienda</Text>
              </TouchableOpacity>
            </View>
          ) : (
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      <View style={{ 
        position: 'absolute', bottom: isDesktop ? 20 : 110, left: 0, right: 0, 
